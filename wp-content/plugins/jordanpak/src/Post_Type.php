...
abstract class Post_Type {
	...
	public function get_label() {
		return __( 'Set CPT Label', 'jordanpak' );
	}
	...
	public function get_plural_label() {
		return __( 'Set Plural CPT Label', 'jordanpak' );
	}
		...
		return array_merge_recursive(
			[
				...
				'labels'            => [
					...
					'add_new'            => __( 'Add New', 'jordanpak' ),
					'not_found'          => __( 'Not found', 'jordanpak' ),
					'not_found_in_trash' => __( 'Not found in Trash', 'jordanpak' ),
				],
				'hierarchical'      => false,
				'show_in_menu'      => true,
				'menu_position'     => 5,
